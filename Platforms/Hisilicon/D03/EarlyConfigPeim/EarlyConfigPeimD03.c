  ...
  )
{
    ...
    if(OemIsMpBoot())
    {
        ...
        //EVENT broadcast
        MmioWrite32(0x60016220, 0x7);
        MmioWrite32(0x60016230, 0x40016260);
        MmioWrite32(0x60016234, 0x0);
        MmioWrite32(0x60016238, 0x60016260);
        MmioWrite32(0x6001623C, 0x400);
        MmioWrite32(0x60016240, 0x40016260);
        MmioWrite32(0x60016244, 0x400);

        MmioWrite32(0x40016220, 0x7);
        MmioWrite32(0x40016230, 0x60016260);
        MmioWrite32(0x40016234, 0x0);
        MmioWrite32(0x40016238, 0x60016260);
        MmioWrite32(0x4001623C, 0x400);
        MmioWrite32(0x40016240, 0x40016260);
        MmioWrite32(0x40016244, 0x400);

        MmioWrite32(0x60016220, 0x7);
        MmioWrite32(0x60016230, 0x40016260);
        MmioWrite32(0x60016234, 0x0);
        MmioWrite32(0x60016238, 0x60016260);
        MmioWrite32(0x6001623C, 0x0);
        MmioWrite32(0x60016240, 0x40016260);
        MmioWrite32(0x60016244, 0x400);
